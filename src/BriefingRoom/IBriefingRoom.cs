...
public interface IBriefingRoom
{
    ...
    DatabaseEntryInfo[] GetDatabaseEntriesInfo(string langKey, DatabaseEntryType entryType, string parameter = "");

    DatabaseEntryInfo? GetSingleDatabaseEntryInfo(DatabaseEntryType entryType, string id);

    DatabaseEntryInfo? GetSingleDatabaseEntryInfo(string langKey, DatabaseEntryType entryType, string id);
    ...
    void PrintTranslatableWarning(string langKey, string key, params object[] args);
