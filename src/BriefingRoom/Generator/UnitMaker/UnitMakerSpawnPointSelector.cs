...
namespace BriefingRoom4DCS.Generator.UnitMaker
{
    internal static class SpawnPointSelector
    {
        ...
        internal static List<DBEntryAirbaseParkingSpot> GetFreeParkingSpots(IBriefingRoom briefingRoom,ref DCSMission mission, int airbaseID, int unitCount, DBEntryAircraft aircraftDB, bool requiresOpenAirParking = false, int reservedSpots = 0)
        {
            ...
            {
                var viableSpots = FilterAndSortSuitableSpots(briefingRoom, mission.LangKey, mission.AirbaseParkingSpots[airbaseID].ToArray(), aircraftDB, requiresOpenAirParking, lastSpot);
        ...
        private static List<DBEntryAirbaseParkingSpot> FilterAndSortSuitableSpots(IBriefingRoom briefingRoom, string langKey, DBEntryAirbaseParkingSpot[] parkingspots, DBEntryAircraft aircraftDB, bool requiresOpenAirParking, DBEntryAirbaseParkingSpot? lastParkingSpot)
        {
