    ...
    string[] featuresID)
        {
            ...
            var (airbase, destinationPoint) = ObjectiveUtils.GetTransportDestination(briefingRoom, ref mission, targetBehaviorDB.Destination, objectiveCoordinates, task.TransportDistance, originAirbase.DCSID);
